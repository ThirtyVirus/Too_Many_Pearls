...
public class healing_pearl extends UberItem {

    public healing_pearl(Material material, String name, UberRarity rarity, boolean stackable, boolean oneTimeUse, boolean hasActiveEffect, List<UberAbility> abilities, UberCraftingRecipe craftingRecipe) {
    ...
    public boolean rightClickAirAction(Player player, ItemStack item) {
        ...
        Utilities.tagEntity(pearl, "a", "healing");
